...
- Add focused behavioral tests for scientific invariants and migration preservation. Keep the local browser usable with static serving; do not require a web service for the first version.
