...
pub use browse::{ExportOutcome, export_browser, local_url};
pub use build::{Projection, build_projection};
pub use config::{IndexConfig, guard_output, load_config};
...
pub enum IndexError {
    ...
    #[error("{0}")]
    Owner(#[from] crate::legacy_owner::OwnerError),
    #[error("{0}")]
